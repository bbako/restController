...
$( document ).ready(function() {
	...
	function makeTable(list){
		 ...
		 $.each(list, function(index, value) {
			 ...
			 str+='<tr><td class="text-center"><a>'+value.bno+'</a></td>'
			 		+'<td class="text-center"><a href = "/board/'+value.bno+'">'+value.title+'</td>'
	...
	function printPageing(pageMaker){
		...
		for(var i=pageMaker.startPage, len = pageMaker.endPage; i <= len; i++){
			...
			var bold = pageMaker.page == i?"class='active'":'';
			
			str += "<li "+bold+"><a href = '"+i+"'>"+i+"&nbsp"+"</a></li>";
			
		}
		
		if(pageMaker.pageNext){
